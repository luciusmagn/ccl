...
(defnx1 nx1-ff-call ((%ff-call)) context (address-expression &rest arg-specs-and-result-spec)
   (nx1-ff-call-internal
    ...
    (ecase (backend-name *target-backend*)
      ((:linuxppc32 :linuxarm :netbsdarm :darwinarm :androidarm) (%nx1-operator eabi-ff-call))
      ...
      ((:linuxx8664 :freebsdx8664 :netbsdx8664 :darwinx8664 :solarisx8664 :win64) (%nx1-operator ff-call)))))
